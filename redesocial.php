...
?><!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8"><title>Rede Social</title><link rel="icon" type="image/png" href="/anotacoes/imagens/icon site.png" sizes="612x612"><link rel="stylesheet" href="estilo.css"><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"><style>
...
</style><div id="msg-flutuante"></div><script>
...
</script></head><body><header>  <div class="bolinhas"><a href="estudos.php">
...
<a href="musica.php">
  ...
  </div>  <div class="usuario-area">  <div class="usuario"><img
...
style="cursor:pointer;">
  ...
  </div></header><!-- Modal de edição do usuário --><div id="modal-editar-usuario" style="display:none;
...
<iframe id="iframe-editar-usuario" 
  ...
  </div></div><div class="wrap">  <div class="feed"><div class="card" id="novo-post">
...
<?php endforeach; ?>
  ...
  </div>  <div class="sidebar"><h3>Sugestões</h3>

<?php foreach($sugestoes as $s): ?>

  <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;"><img src="<?= htmlspecialchars($s['foto'] ?: 'imagens/usuarios/default.jpg') ?>" style="width:46px;height:46px;border-radius:50%;object-fit:cover;border:2px solid var(--primary);">
...
<button onclick="adicionarAmigo(<?= intval($s['id']) ?>)" 
  ...
  </div><?php endforeach; ?><hr style="margin:14px 0;">
...
<div id="amigos-online">
  ...
  </div></div><div id="modal" style="display:none;position:fixed;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.5);align-items:center;justify-content:center;z-index:1000;">  <div style="background:#fff;padding:20px;border-radius:12px;max-width:420px;width:90%;position:relative;"><button onclick="fecharModal()" style="position:absolute;right:12px;top:12px;background:none;border:none;font-size:18px;cursor:pointer;">&times;</button>
